...
def straight_change(actor_information_array):
	...
	print("acotr", actor_six,actor_seven)
	rerative_distance(actor_six, actor_seven)
...
def change_npc_position(actor_information_array):
	...
	Straight = True
	if Straight == True:
		straight_change(actor_information_array)
...
def main():
	...
	change_npc_position(actor_information_array)
